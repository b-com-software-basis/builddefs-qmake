...
exists($${APPCONFIG_FILEPATH}) {
    ...
    APPCONFIG_IN_CONTENT = $$replace(APPCONFIG_IN_CONTENT, "@JUCEPLUGIN_AAXIDENTIFIER@", "com.remaken.$${PRODUCT_NAME}")
    ...
    APPCONFIG_IN_CONTENT = $$replace(APPCONFIG_IN_CONTENT, "@JUCEPLUGIN_CFBUNDLEIDENTIFIER@", "com.remaken.$${PRODUCT_NAME}")
