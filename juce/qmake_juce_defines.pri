...
!contains(QMAKE_JUCEDEFINES,"defined") {
    ...
    exists("$${_REMAKEN_LIBS_ROOT_}/libs/remaken-Juce") {
       JUCEFOLDER = "remaken-Juce"
    } else {
        exists("$${_REMAKEN_LIBS_ROOT_}/libs/Juce") {
            JUCEFOLDER = "Juce"
        } else {
    ...
    JUCEPATH = $${_REMAKEN_LIBS_ROOT_}/libs/$${JUCEFOLDER}/modules
    message("Using Juce submodule from $${JUCEPATH}")

    VSTSDKPATH = $${_REMAKEN_LIBS_ROOT_}/libs/Steinberg/VST3_SDK
